        ...
        {movies.map((movie, i) => (
          <div key={i}>
            <div className="ind-movie-wrapper">
              <a href="#">
                <ind-movie-h1>{movie.title}</ind-movie-h1>
              </a>
              <ind-movie-nav>
              ...
              <div className="poster">
                <img src="{movie.backdrop_path}" alt="ava" />
              </div>
              ...
              <div id="fade" className="container-margin">
                <div className="ind-movie-header ">
                  ...
                  <p className="movie__description">
                    ...
                    evaluating the human qualities of a breath-taking female
                    A.I.
                  </p>
                  ...
                  <ul>
                    <li>
                      ...
                      <p className="review__description">
                        ...
                        very unique way. It doesn&apos;t bombard you with
                        effects or superficial action (although the robot
                        effects are exceptional). Rather, its focus and beauty
                        lie in the subtle and nuanced performances of its tiny
                        cast as the film explores what it means to be human.
                      </p>
                    </li>
                    <li>
                      <div className="review__score">91%</div>
                      <p className="review__description">
                        Quiet dialogue scenes between two characters are filmed
                        in such an impactful, making them feel hauntingly
                        austere, sweet and innocent, or terrible and
                        frightening, through meticulous use of composition,
                        light and sound. The film really does run the gamut of
                        emotions, surprisingly funny one minute and
                        gut-wrenchingly tense and weird the next, while the
                        script twists and turns, constantly unsettling your
