...
var typing = styled.keyframes(_templateObject || (_templateObject = _taggedTemplateLiteralLoose(["\n  from { width: 0 }\n"])));
var blinkCursor = styled.keyframes(_templateObject2 || (_templateObject2 = _taggedTemplateLiteralLoose(["\n  0% {border-right-color: rgba(255,255,255,.75);}\n  50% {border-right-color: transparent;}\n  100% {border-right-color: rgba(255,255,255,.75);}\n"])));
var InputWrapper = styled__default.div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteralLoose(["\n  display: flex;\n  align-items: center;\n  color: #f5f5f5;\n  border: 1px solid #f5f5f5;\n  border-radius: 8px;\n  padding: 10px;\n  width: 100%;\n"])));
var StyledInput = styled__default.input(_templateObject4 || (_templateObject4 = _taggedTemplateLiteralLoose(["\n  color: #f5f5f5;\n  background: none;\n  border: none;\n  padding: 0 10px;\n  width: 80%;\n  outline: none;\n  font-family: ", ";\n  font-size: 20px;\n  &::placeholder {\n    animation: ", " 2s steps(30, end), ", " .75s step-end infinite;\n    overflow: hidden;\n    white-space: nowrap;\n    border-right: .1em solid;\n  }\n"])), function (props) {
...
var ReactTypingAnimation = function ReactTypingAnimation(_ref) {
  ...
  }, renderIcon && renderIcon(), /*#__PURE__*/React__default.createElement(StyledInput, {
...
module.exports = ReactTypingAnimation;
