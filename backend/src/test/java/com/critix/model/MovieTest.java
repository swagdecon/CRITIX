...
class MovieTest {
    ...
    // Movie movie = new Movie(id, adult, backdropUrl, genreIds, genres, movieId,
    // originalLanguage,
    // originalTitle, overview, popularity, posterUrl, releaseDate, title, trailer,
    // adult, adult, voteAverage,
    // null, voteCount, imdbId, budget, tagline, revenue, runtime, actors,
    // actorImagePaths, reviews,
    // productionCompanies,
    // movieStatus);
